...
- [Troubleshooting](#troubleshooting)- [No menu items show up on the menu editor page. How do I fix this?](#no-menu-items-show-up-on-the-menu-editor-page-how-do-i-fix-this)
...
- [Can I use this plugin together with another plugin that also edits the admin menu?](#can-i-use-this-plugin-together-with-another-plugin-that-also-edits-the-admin-menu)
...
### Can I use this plugin together with another plugin that also edits the admin menu?

It’s not recommended to edit the admin menu with two different plugins at the same time. You may run into plugin conflicts, such as changes made by one of the plugins not showing up in the actual admin menu. However, if the other plugin has additional features unrelated to editing the admin menu, you can usually still use those features.
