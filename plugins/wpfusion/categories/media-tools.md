...
- Updated wpfselect package to 1.1.6

#### #1.5.1 - 12/27/2024

- ⚡️ Improved YouTube players added to a page via <iframe> HTML will now automatically add the enablejsapi=1 parameter to the URL
...
- ✨ New Added FV Player integration
- ✨ New Added Bunny Stream integration
...
- ✨ New Added block editor integration
- Removed jQuery dependency on the frontend

#### #1.3.0 - 6/16/2023

- Updated Presto Player integration to use the block editor
...
WP Fusion’s block editor integration lets you apply tags in your CRM based on engagement with videos on your site.
...
WP Fusion’s Media Tools addon lets you apply tags in your CRM based on engagement with videos on your site.
The Media Tools addon supports videos embedded with the following players:

- The Video, YouTube and Vimeo blocks in the block editor
- Bunny Stream
- Elementor
- FV Player
- Presto Player
