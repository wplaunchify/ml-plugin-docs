...
Using WP Fusion you can [track events](https://wpfusion.com/documentation/event-tracking/event-tracking-overview/) from WordPress plugins in [Encharge](https://wpfusion.com/go/encharge)— allowing you to track customer behavior on your site and trigger flows based on purchases, course progress, video engagement, form submissions, and more.
...
You can [configure events globally](https://wpfusion.com/documentation/event-tracking/event-tracking-overview/#how-to-configure-events), or on individual courses, forms, and products.

![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-buddyboss-1024x961.jpg)Syncing events from [BuddyBoss](https://wpfusion.com/documentation/membership/buddypress/#event-tracking) allows you to send additional details like the forum topic title, content, and group name (when someone joins a group).
Each event can contain a title, and any number of key/value pairs containing the event data.

![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-woocommerce-multi-key-1024x990.jpg)In this example [WooCommerce](https://wpfusion.com/documentation/ecommerce/woocommerce/#event-tracking) product purchases and new orders are configured to send events to Omnisend.
When an event is tracked in a supported plugin, it will be recorded to the [WP Fusion activity logs](https://wpfusion.com/documentation/getting-started/activity-logs/), and sent to the corresponding person’s subscriber record in Encharge.

![](https://wpfusion.com/wp-content/uploads/2024/01/event-tracking-learndashuser-957x1024.jpg)WP Fusion’s [event tracking with LearnDash](https://wpfusion.com/documentation/learning-management/learndash/#event-tracking) supports course progress and quiz attempts.
...
For more information on events in Encharge, [see the Encharge documentation](https://encharge.io/features/event-management/).

### How it looks

Events are displayed in the activity timeline on Encharge subscriber records.

![A subscriber record in Encharge showing events added by WP Fusion](https://wpfusion.com/wp-content/uploads/2024/05/encharge-events-timeline-1024x648.jpg)Events from WordPress appear on the subscriber’s activity timeline in real time.
In this case, we’re using the [LearnDash integration](https://wpfusion.com/documentation/learning-management/learndash/#event-tracking) to sync course progress as events. You can click on any event to expand it and see its properties (for example quiz score, course progress, or last lesson completed).

Events can also be used as triggers in automations.

![A screenshot showing the configuration of an event trigger in an Encharge flow.](https://wpfusion.com/wp-content/uploads/2024/05/ecnharge-event-triggers-1024x786.jpg)Events can trigger Flows in Encharge. In this example an email is sent when a user completes the second lesson in the course.
...
Using WP Fusion you can [track events](https://wpfusion.com/documentation/event-tracking/event-tracking-overview/) from WordPress plugins in [Omnisend](https://wpfusion.com/go/omnisend)— allowing you to track customer behavior on your site and trigger automations based on purchases, course progress, video engagement, form submissions, and more.
...
![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-woocommerce-multi-key-1024x990.jpg)In this example [WooCommerce](https://wpfusion.com/documentation/ecommerce/woocommerce/#event-tracking) product purchases and new orders are configured to send events to Omnisend.
When an event is tracked in a supported plugin, it will be recorded to the [WP Fusion activity logs](https://wpfusion.com/documentation/getting-started/activity-logs/), and sent to the corresponding person’s subscriber record in Omnisend.

![](https://wpfusion.com/wp-content/uploads/2024/01/event-tracking-learndashuser-957x1024.jpg)WP Fusion’s [event tracking with LearnDash](https://wpfusion.com/documentation/learning-management/learndash/#event-tracking) supports course progress and quiz attempts.
Tracked events will then show up in that subscribers activity timeline, and can also be used as triggers and conditions in automations.

For more information on events in Omnisend, [see the Omnisend documentation](https://support.omnisend.com/en/articles/1475482-custom-events).
...
![](https://wpfusion.com/wp-content/uploads/2024/01/omnisend-events-workflows-1024x645.jpg)Custom events can be used as triggers in automations, and event properties can be used as conditions.
In this example, we’ve triggered a Quiz Attempt event whenever a quiz is attempted in [LearnDash](https://wpfusion.com/documentation/learning-management/learndash/#event-tracking).
...
Using WP Fusion you can track events from supported plugins in [Customer.io](https://customer.io/).
...
You can [configure events](https://wpfusion.com/documentation/event-tracking/event-tracking-overview/#how-to-configure-events) globally, or on individual courses, forms, and products.

![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-woocommerce-multi-key-1024x990.jpg)In this example WooCommerce product purchases and new orders are configured to send events to Bento.
Each event can contain a title, and any number of key/value pairs containing the event data.

When an event is tracked in a supported plugin, it will be recorded to the [WP Fusion activity logs](https://wpfusion.com/documentation/getting-started/activity-logs/), and sent to the corresponding person’s contact record in Customer.io.
...
![](https://wpfusion.com/wp-content/uploads/2024/01/customer-io-event-tracking-1024x633.jpg)This person’s event log shows their course progress from [LearnDash](https://wpfusion.com/documentation/learning-management/learndash/#event-tracking) or [LifterLMS](https://wpfusion.com/documentation/learning-management/lifterlms/#event-tracking) in Customer.io.
You can click on any event to expand it and see its properties.

Events can also be used as campaign triggers.

![](https://wpfusion.com/wp-content/uploads/2024/01/customer-io-event-driven-campaigns-1024x641.jpg)In this example, the campaign is triggered when a Quiz Attempted event fires with a 
```
score
```
...
![](https://wpfusion.com/wp-content/uploads/2024/01/customer-io-event-goals-1024x921.jpg)In this example, the campaign ends when the Course Progress goal is triggered with a 
```
percent
```
...
![](https://wpfusion.com/wp-content/uploads/2023/11/fluentcrm-event-trigger-count-1024x634.jpg)This automation is triggered once the 
```
logged-in
```
...
![screenshot](https://wpfusion.com/wp-content/uploads/2023/11/fcrm-event-tracking-unique-event-name-1024x576.jpg)Adding a unique identifier to the event name will make FluentCRM record a new event every time it’s triggered by WP Fusion.
For example here, we’ve set the event name to 
```
...
![screenshot](https://wpfusion.com/wp-content/uploads/2023/11/fcrm-non-unique-event-name-1024x472.jpg)Using a non-unique event name will cause FluentCRM to only record the details from the most recent event.
But for order status changes, we don’t necessarily need to see every time it’s changed in the past, we just need the status change from the most recent order to trigger automations. By setting the event name to 
```
...
![](https://wpfusion.com/wp-content/uploads/2023/11/fluentcrm-enable-event-tracking-1024x603.jpg)
...
![](https://wpfusion.com/wp-content/uploads/2023/11/fluentcrm-single-key-event-1024x280.jpg)
...
![](https://wpfusion.com/wp-content/uploads/2023/11/fluentcrm-single-key-event-in-timeline.jpg)

The event value can then **be used as a condition in automation triggers**.

![](https://wpfusion.com/wp-content/uploads/2023/11/fluentcrm-event-tracking-trigger-1024x733.jpg)

In this example the automation is triggered when the 
```
quiz-attempt
```
...
![](https://wpfusion.com/wp-content/uploads/2023/11/fluentcrm-multi-key-event-1024x794.jpg)
...
![](https://wpfusion.com/wp-content/uploads/2023/11/fluentcrm-multi-key-event-in-timeline.jpg)
...
When an event is tracked in a supported plugin, it will be recorded to the [WP Fusion activity logs](https://wpfusion.com/documentation/getting-started/activity-logs/), and sent to the corresponding person’s contact record in Klaviyo.
...
Klaviyo uses the events system for tracking orders and ecommerce activity. According to the [Klaviyo documentation](https://developers.klaviyo.com/en/docs/guide_to_integrating_a_platform_without_a_pre_built_klaviyo_integration#placed-order), to track orders in WooCommerce or another ecommerce plugin, you will need to set up two events:

- **Placed Order:**This event must be titled *Placed Order* and contain at minimum a 
```
value
```

 field set to the total value of the order. In WP Fusion this uses the “Order Placed” trigger.
- **Ordered Product:**This event must be titled *Ordered Product* and contain at minimum a 
```
value
```

 field that represents the total cost of the item. In WP Fusion this uses the “Purchased Product” trigger.

![a wordpress admin dashboard shows the wp fusion plugin’s woocommerce settings, displaying event tracking automation triggers with order and product details, including integration options for klaviyo, event names, values, and test event data.](https://wpfusion.com/wp-content/uploads/2022/11/event-tracking-klaviyo-ecommerce-1024x907.jpg)An example of the Event Tracking addon configured to track WooCommerce orders in Klaviyo
...
Using WP Fusion you can track events from supported plugins in [Brevo](https://wpfusion.com/go/sendinblue).

For an overview of event tracking in Brevo in general, see [this link](https://tracker-doc.sendinblue.com/docs/getting-started-1).
...
When an event is tracked in a supported plugin, it will be recorded to the [WP Fusion activity logs](https://wpfusion.com/documentation/getting-started/activity-logs/), and sent to the corresponding person’s contact record in Brevo.

Tracked events will then show up in the [Brevo automation logs](https://automation.sendinblue.com/log/events), and can be used as trigger and conditions in automations.
...
![](https://wpfusion.com/wp-content/uploads/2022/05/brevo-event-tracking-trigger-1024x857.jpg)
...
For an overview of event tracking in Intercom in general, see [this link](https://www.intercom.com/help/en/articles/175-set-up-event-tracking-in-intercom).
...
When an event is tracked in a supported plugin, it will be recorded to the [WP Fusion activity logs](https://wpfusion.com/documentation/getting-started/activity-logs/), and sent to the corresponding person’s contact record in Intercom.
...
![](https://wpfusion.com/wp-content/uploads/2021/12/Intercom-Event-Tracking-1024x533.jpeg)

Events can also be used as a Series’ Entry rule trigger.

![](https://wpfusion.com/wp-content/uploads/2021/12/Intercom-Event-Tracking-Series-Entry-Rule-Trigger.jpeg)
...
For an overview of event tracking in Gist in general, see [this link](https://docs.getgist.com/article/23-introduction-to-gist-event-tracking).
...
When an event is tracked in a supported plugin, it will be recorded to the [WP Fusion activity logs](https://wpfusion.com/documentation/getting-started/activity-logs/), and sent to the corresponding person’s contact record in Gist.
...
![](https://wpfusion.com/wp-content/uploads/2021/12/Gist-Event-Tracking-1-1024x528.jpeg)

Events can also be used as a Workflow trigger.

![](https://wpfusion.com/wp-content/uploads/2021/12/Gist-Event-Tracking-Workflow-Trigger-1.jpeg)

And as a trigger to Automation Rules:

![](https://wpfusion.com/wp-content/uploads/2021/12/Gist-Event-Tracking-Event-Rules.jpeg)
...
![Enable event tracking in ActiveCampaign](https://wpfusion.com/wp-content/uploads/2021/12/event-tracking-enable-in-ac-1024x591.png)Event tracking in ActiveCampaign must be enabled before it can be used.
...
![ActiveCampaign event tracking](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-gravity-forms-entries-activecampaign-1024x689.png)Events tracked by WP Fusion show up in the Activity timeline to the right of the contact record. In this case, we see two Gravity Form submissions.
![Event Tracking Course Progress](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-activecampaign-1024x662.jpg)In this example we can see course progress from a LearnDash course being tracked via events.
...
![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-ac-triggers-1024x667.jpg)Events can be used as automation triggers, optionally with event values
...
![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-conditions-1024x571.jpg)Events can be used in conditions in automations
...
Using WP Fusion you can track events from supported plugins in [Mailchimp](https://mailchimp.com/).

For an overview of event tracking in Mailchimp in general, see [this link](https://mailchimp.com/developer/marketing/guides/track-outside-activity-events/).
...
When an event is tracked in a supported plugin, it will be recorded to the [WP Fusion activity logs](https://wpfusion.com/documentation/getting-started/activity-logs/), and sent to the corresponding person’s contact record in Mailchimp.
...
![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-mailchimp-1-1024x634.jpeg)

Events can also be used as triggers in your automations.

![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-mailchimp-automation.jpeg)
...
Using WP Fusion you can track events from supported plugins in [Bento](https://wpfusion.com/go/bento/).
...
When an event is tracked in a supported plugin, it will be recorded to the [WP Fusion activity logs](https://wpfusion.com/documentation/getting-started/activity-logs/), and sent to the corresponding person’s contact record in Bento.
...
![](https://wpfusion.com/wp-content/uploads/2021/11/bento-single-event-1024x591.jpg)

Events can also be used as workflow triggers.

![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-bento-workflow-trigger.jpeg)
...
Using WP Fusion you can track events from supported plugins in [Drip](https://wpfusion.com/go/drip/).

For an overview of event tracking in Drip in general, see [this link](https://www.drip.com/learn/docs/manual/events).
...
When an event is tracked in a supported plugin, it will be recorded to the [WP Fusion activity logs](https://wpfusion.com/documentation/getting-started/activity-logs/), and sent to the corresponding person’s contact record in Drip.
...
![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-drip-1024x717.jpeg)

Events can also be used as a workflow trigger.

![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-drip-workflow-trigger.jpeg)

To filter the trigger by the event “value”, you can use the “data” parameter in the filter, like so:

![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-drip-value-1024x909.jpg)
...
Using WP Fusion you can track events from supported plugins in [HubSpot](https://wpfusion.com/go/hubspot/), as engagements.

For an overview of engagements in HubSpot in general, see [this link](https://developers.hubspot.com/docs/api/crm/engagements).
...
When an event is tracked in a supported plugin, it will be recorded to the [WP Fusion activity logs](https://wpfusion.com/documentation/getting-started/activity-logs/), and sent to the corresponding person’s contact record in HubSpot as an engagement.
...
![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-hubspot-1024x751.jpeg)
...
```
 ...
 in LearnDash Course Started event
...
- 🔧 Fixed Fixed login events not working with WishList Member (moved 
```
wp_login
```

 priority from 10 to 5)
...
- ⚡️ Improved With the Gravity Forms integration, when using the 
```
{form:all_fields}
```

 merge tag, the event value will now be an array of all the form fields when using multi-key event tracking
...
- 🛠️ Dev added action 
```
wpf_event_tracking_track_event
```

 to allow passing events to other services
...
```
wpf_track_event( $event_name, $event_data, $email_address );
```
...
- 🔧 Fixed Fixed fatal error in Presto Player integration (
```
WPF_ET_Presto_Player does not have a method "add_meta_box()"
```
...
```
 ...
 merge tag for EDD
- ⚡️ Improved Improved LearnDash progress tracking — no longer running on 
```
learndash_update_user_activity
```

 hook (was triggering duplicate events)
...
![](https://wpfusion.com/wp-content/uploads/2021/11/groundhogg-custom-activity-trigger-1024x515.jpg)

For the type of activity, enter 
```
wp_fusion
```
...
![](https://wpfusion.com/wp-content/uploads/2021/11/groundhogg-event-trigger-benchmark-1024x325.jpg)

You can optionally filter the trigger by the 
```
event_name
```
...
```
 ...
 parameters. These will match the Event Name and Event Values you set when configuring your events [in the WP Fusion settings](https://wpfusion.com/documentation/event-tracking/event-tracking-overview/).

![](https://wpfusion.com/wp-content/uploads/2021/11/groundhogg-custom-activity-in-timeline-1024x304.jpg)Custom activity benchmarks triggered by WP Fusion will be displayed in the contact’s timeline.

### How it looks

Events are displayed on the Activity timeline on Groundhogg contact records.

![Groundhogg event tracking](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-groundhogg-1024x516.png)Events tracked by WP Fusion are shown on the Activity timeline on each person’s Groundhogg contact record.
Events can also be used as benchmarks or conditions, including the number of times the event happened, and the time period.

![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-groundhogg-2-1024x455.png)
...
- [ActiveCampaign](https://wpfusion.com/documentation/event-tracking/activecampaign-event-tracking/)
- [Bento](https://wpfusion.com/documentation/event-tracking/bento-event-tracking/)
- [Brevo](https://wpfusion.com/documentation/event-tracking/sendinblue-event-tracking/)
- [Customer.io](https://wpfusion.com/documentation/event-tracking/customer-io-event-tracking/)
- [Drip](https://wpfusion.com/documentation/event-tracking/drip-event-tracking/)
- [Encharge](https://wpfusion.com/documentation/event-tracking/encharge-event-tracking/)
- [FluentCRM](https://wpfusion.com/documentation/event-tracking/fluentcrm-event-tracking/)
- [Gist](https://wpfusion.com/documentation/event-tracking/gist-event-tracking/)
- [Groundhogg](https://wpfusion.com/documentation/event-tracking/groundhogg-event-tracking/)
- [HubSpot](https://wpfusion.com/documentation/event-tracking/hubspot-event-tracking/)
- [Intercom](https://wpfusion.com/documentation/event-tracking/intercom-event-tracking/)
- [Klaviyo](https://wpfusion.com/documentation/event-tracking/klaviyo-event-tracking/)
- [Mailchimp](https://wpfusion.com/documentation/event-tracking/mailchimp-event-tracking/)
- [Omnisend](https://wpfusion.com/documentation/event-tracking/omnisend-event-tracking/)
...
WP Fusion can track user activity by applying tags in your CRM or marketing automation platform, for example based on a [product purchase](https://wpfusion.com/documentation/ecommerce/woocommerce/#tagging-customers) or [course progress](https://wpfusion.com/documentation/learning-management/lifterlms/#courses).

Tags can then be used to [unlock content on your site](https://wpfusion.com/documentation/getting-started/access-control/), trigger [automated enrollments](https://wpfusion.com/documentation/learning-management/learndash/#course-settings-and-auto-enrollment), or to trigger automations or email sequences in your CRM.
...
![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-tags-bad-1024x398.jpg)Using tags to track progress or page views can clutter up your account.
...
![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-activecampaign-1024x662.jpg)WP Fusion tracks events in the Recent Activities list in ActiveCampaign, where you can see the full timeline of event activity.
...
![Event Tracking Global Settings](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-global-settings-1024x791.jpg)The Event Tracking global settings provide an overview of every post on your site that is configured to track events, as well as the option to track global events.
...
With [Bento](https://wpfusion.com/documentation/event-tracking/bento-event-tracking/), [Brevo](https://wpfusion.com/documentation/event-tracking/brevo-event-tracking/), [Customer.io](https://wpfusion.com/documentation/event-tracking/customer-io-event-tracking/), Engage, [FluentCRM](https://wpfusion.com/documentation/event-tracking/fluentcrm-event-tracking/), [Gist](https://wpfusion.com/documentation/event-tracking/gist-event-tracking/), [Groundhogg](https://wpfusion.com/documentation/event-tracking/groundhogg-event-tracking/), [Intercom](https://wpfusion.com/documentation/event-tracking/intercom-event-tracking/), [Klaviyo](https://wpfusion.com/documentation/event-tracking/klaviyo-event-tracking/), [Mailchimp](https://wpfusion.com/documentation/event-tracking/mailchimp-event-tracking/), and [Omnisend](https://wpfusion.com/documentation/event-tracking/omnisend-event-tracking/), events can contain any number of key/value pairs.

![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-buddyboss-1024x961.jpg)Syncing multi-key events from [BuddyBoss](https://wpfusion.com/documentation/membership/buddypress/#event-tracking) allows you to send additional details like the forum topic title, content, and group name (when someone joins a group).
...
![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-woocommerce-multi-key-1024x990.jpg)
...
![](https://wpfusion.com/wp-content/uploads/2021/11/event-tracking-global-1024x533.jpg)

There is currently one setting:

- **Log Events:**By default all events are recorded to the [activity logs](https://wpfusion.com/documentation/getting-started/activity-logs/). If you don’t want to record events to the logs, you can un-check this setting.
