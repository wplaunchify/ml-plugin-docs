...
![Broken Header](https://www.liquidweb.com/wp-content/uploads/2025/07/Pic1-scaled.jpg)![Fixed Header](https://www.liquidweb.com/wp-content/uploads/2025/07/Pic2-scaled.jpg)
...
3. In the **Elements panel**, navigate up the HTML structure until you find the parent-level header container.- Look for: 
```
header#masthead.site-header
```

. This is the main wrapper for your entire header.
4. Once it’s selected, you will see a value pop-up below the selected header element.- You’ll see something like: 
```
1177 × 149
```
...
![Determining Header Height](https://www.liquidweb.com/wp-content/uploads/2025/07/Determining-Header-Height.gif)This number is important because it tells you how much top padding you’ll need to add to your content.

![Header Height Style Box](https://www.liquidweb.com/wp-content/uploads/2025/07/Header-Height-Style-Box.jpg)You can also select the 
```
header#masthead.site-header
```
...
![Computed](https://www.liquidweb.com/wp-content/uploads/2025/07/Computed.jpg)
---
...
![Adjusting Min Heights](https://www.liquidweb.com/wp-content/uploads/2025/07/Adjusting-Min-Heights.gif)Using In-Content Title LayoutsIf you’re using an **In Content** title layout, you may notice spacing issues when a Transparent Header is enabled. In these cases, you have a couple of options:
...
![Removing Paddings](https://www.liquidweb.com/wp-content/uploads/2025/07/Removing-Paddings.gif)
#### Using a Hooked Element for Hero or Title

If you’re using a **Hooked Element** ([from Kadence Theme Kit Pro](https://www.liquidweb.com/pricing/)) to add a custom title or hero section:
...
![Element Padding](https://www.liquidweb.com/wp-content/uploads/2025/07/Element-Padding.gif)*You can learn more about Hooked Elements here.*
...
![Disabling the Transparent Header](https://www.liquidweb.com/wp-content/uploads/2025/07/Disabling-the-Transparent-Header.gif)*If you’ve made it this far, congratulations!*
