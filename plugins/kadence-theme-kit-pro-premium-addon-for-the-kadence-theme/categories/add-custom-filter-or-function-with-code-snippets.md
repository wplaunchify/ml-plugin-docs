# Add Custom Filter Or Function With Code Snippets
...
**Source:** [https://www.kadencewp.com/help-center/docs/kadence-theme/add-custom-filter-or-function-with-code-snippets/](https://www.kadencewp.com/help-center/docs/kadence-theme/add-custom-filter-or-function-with-code-snippets/)
...
![Installing Code Snippets via WordPress Admin](https://www.liquidweb.com/wp-content/uploads/2020/11/Screenshot-2025-09-26-at-1.03.20-PM-scaled.png)Once installed and activated, you can navigate to **Snippets** in your admin menu. Code Snippets provides several example snippets that you can use and/or edit to see how things work.

![Code Snippets Dashboard](https://www.liquidweb.com/wp-content/uploads/2020/11/Screenshot-2025-09-26-at-1.10.57-PM-scaled.png)If you want to learn more about the plugin and it’s available settings check out the [WordPress plugin page](https://wordpress.org/plugins/code-snippets/).
...
![Code Snippets - adding a new PHP snippet](https://www.liquidweb.com/wp-content/uploads/2020/11/Screenshot-2025-09-26-at-1.14.55-PM-scaled.png)Once you’ve added your function and set the Location, click **Save and Activate**.  If your snippet contains any syntax errors, **it will not activate**.
...
![Code Snippets - adding an HTML snippet](https://www.liquidweb.com/wp-content/uploads/2020/11/Screenshot-2025-09-26-at-12.54.29-PM-scaled.png)Optionally add a description and tag and then **Save and Activate** your snippet.
