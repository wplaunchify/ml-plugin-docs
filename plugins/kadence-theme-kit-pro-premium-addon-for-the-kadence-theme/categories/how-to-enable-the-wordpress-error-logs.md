...
![Viewing the debug log](https://www.liquidweb.com/wp-content/uploads/2024/09/Viewing-the-debug-log.gif)Previously logged or triggered PHP errors will not appear in the WordPress Error Log. If you do not see a 
```
debug.log
```
