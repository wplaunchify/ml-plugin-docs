...
For simplicity and ease of use, Kadence has been developed to be customizable via the WordPress Customizer.  Most users may not need to use a child theme when using Kadence.  If you need to add a function or custom filter, we often suggest using a [code snippets plugin](https://www.liquidweb.com/docs/kadence-theme/how-to-add-a-custom-filter-or-function-with-code-snippets/).
...
[Download Kadence Child Theme](https://www.liquidweb.com/wp-content/uploads/2020/07/kadence-child.zip)
...
For a deeper look at when and why you might want to consider child themes versus the WordPress Customizer, we have a [blog post](https://www.liquidweb.com/blog/custom-css-should-you-use-a-wordpress-child-theme-or-the-customizer/) that explores this further.
