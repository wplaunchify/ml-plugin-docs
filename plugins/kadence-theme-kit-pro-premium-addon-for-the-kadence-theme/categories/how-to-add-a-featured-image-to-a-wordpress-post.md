...
**Source:** [https://www.kadencewp.com/help-center/docs/kadence-theme/how-to-add-a-featured-image-to-a-wordpress-post/](https://www.kadencewp.com/help-center/docs/kadence-theme/how-to-add-a-featured-image-to-a-wordpress-post/)
...
1. Create or Edit a Post- In WP Admin, under **Posts** click **Add New**.
- Or, click **All Posts** and select a post to edit.
2. Locate the **Set featured image** button.- On the right-hand sidebar, scroll down to the **Set featured image** button.
- If you don’t see it, make sure to click on the **Post** tab on the top of the settings section.
3. Click the **Set featured image** button.- You can select an existing image from the Media Library.
- Or, you can upload a new image.
- Once selected, click the **Set featured image** button on the bottom-right of your screen.
4. Save your post.- You should see a thumbnail of your featured image in the Post settings panel.
- Click Publish (for new posts) or Update (for existing posts) to save your changes.![WordPress Post Settings - Featured Image](https://www.liquidweb.com/wp-content/uploads/2025/06/Screenshot-2025-06-10-at-2.17.25 PM-420x1024.png)
