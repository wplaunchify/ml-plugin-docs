# Use Hook Elements Inside Post Or Page Content
...
**Source:** [https://www.kadencewp.com/help-center/docs/kadence-theme/use-hook-elements-inside-post-or-page-content/](https://www.kadencewp.com/help-center/docs/kadence-theme/use-hook-elements-inside-post-or-page-content/)
...
Just one amazing thing they allow you to do is restrict content to certain posts, pages and even users. There are entire plugins devoted to that purpose and here is a Kadence hooked element ready to do it all, humbly waiting in the background. When you get right down to it, hooked elements have overwhelming potential. Naturally, that does mean they are a premium feature available in [Theme Kit Pro](https://www.liquidweb.com/software/kadence/).

## Enable Hooked Elements

To get started, let’s walk through how to enable Hooked Elements. As mentioned before, this is a [Kadence Theme Kit Pro](https://www.liquidweb.com/software/kadence/) feature so make sure you have installed and activated the Kadence Theme Kit Pro plugin to enable this feature. It is included in the[Kadence Plus Plan](https://www.liquidweb.com/pricing/)or greater and can also be purchased [individually](https://www.liquidweb.com/software/kadence/).

Once you have installed and activated Kadence Theme Kit Pro, enter your license key at Appearance > Kadence.

![](https://www.liquidweb.com/wp-content/uploads/2022/07/activate-pro-1024x584.png)You will notice all the Premium Addons for the Kadence Theme have been unlocked and are available. You can now enable the Hooked Elements option.

![](https://www.liquidweb.com/wp-content/uploads/2022/07/enable-elements.png)![](https://www.liquidweb.com/wp-content/uploads/2022/07/Screen-Shot-2022-07-04-at-6.49.21-PM.png)Once “Hooked Elements” is enabled, refresh your page. Now you should be able to see an additional submenu item under “Kadence” titled “Elements.”
...
![Adding a new element in Kadence](https://www.liquidweb.com/wp-content/uploads/2020/09/kadence-elements-add-new-1024x218.png)Now you should see 4 options that intimidate you and tempt you to forget hooked elements ever existed. But wait!! I’m here to explain everything! We ‘re going to take this one step at a time. 
...
- Fixed Section
- Template
- HTML Editor![](https://www.liquidweb.com/wp-content/uploads/2022/07/Screen-Shot-2022-07-05-at-10.58.21-AM-edited-1.png)
## 1. Content Section
...
Potential Use Cases:- Secondary header
- Sale Banner
## 2. Fixed Section
...
Potential Use Cases:- When [displaying custom post types](https://youtu.be/WQkpUtivvto)
- Instances using [dynamic](https://youtu.be/WQkpUtivvto)[content](https://youtu.be/WQkpUtivvto) or advanced custom fields
## 4. HTML Editor
...
Potential Use Cases:- Custom code
- Custom CSS class
- SVG
## Element Settings
...
![](https://www.liquidweb.com/wp-content/uploads/2022/07/content-element-settings.jpg)In the screenshot above I have chosen to use the **Content Section** element type. This is just a row block with a background, advanced text, advanced buttons and a bottom row with a search bar, nothing too crazy. 
...
Once the element is configured, publish it to see it in action.![](https://www.liquidweb.com/wp-content/uploads/2022/07/Screen-Shot-2022-07-05-at-4.53.10-PM.png)Was this article helpful?Yes NoThank you for your input.Thank you for your feedback.
