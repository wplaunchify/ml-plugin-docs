...
**Source:** [https://www.kadencewp.com/help-center/docs/kadence-theme/how-to-add-an-author-box-to-your-posts/](https://www.kadencewp.com/help-center/docs/kadence-theme/how-to-add-an-author-box-to-your-posts/)
...
2. Navigate to Posts/Pages Layout → Single Post Layout
3. Scroll to the section labeled **Default Post Layout**.
4. Find the toggle for **Show Post Author Box?** and turn it ON.
5. Choose an **Author Box Style**:  Normal or Center.
...
1. From the WordPress dashboard, go to Users → All Users.
2. Click on an author’s username to edit their profile.
3. Optionally, adjust the user’s **Display Name** (this will show on the front-end of your site)
4. Fill out the **Biographical Info** section with a short bio.
5. Add a **Profile Picture** using [Gravatar](https://gravatar.com/) (WordPress uses this service by default).
6. Under **Extra profile information for author box**, add the author’s **social links**.
