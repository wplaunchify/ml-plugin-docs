...
*Category from Debug Log Manager Tool documentation*

---

## Debug Log Manager – Conveniently Monitor and Inspect Errors

**Source:** [https://wordpress.org/plugins/debug-log-manager/](https://wordpress.org/plugins/debug-log-manager/)
...
```
 ...
 the log file on the command line.
...
- **Use error_log()** to output error info into your debug log. e.g. 
```
error_log( $error_message )
```

 for simple, string-based error message, or 
```
...
*“This is a great plugin for dev especially for people who tinker in the code.”* ~[PK Son](https://wordpress.org/support/topic/great-for-dev/)

*“I have used a couple of other logger plugins and this is by far the best one.”* ~[Brian Henry](https://wordpress.org/support/topic/must-have-plugin-485/)

*“Another massive time-saving tool.“* ~[Jeff Starr](https://digwp.com/2023/06/plugins-troubleshoot-debug-wordpress/)
...
## Screenshots
	...
	![Debug Log Manager main page](https://ps.w.org/debug-log-manager/assets/screenshot-1.png?rev=2828163)Debug Log Manager main page

![Fatal errors with the stack trace](https://ps.w.org/debug-log-manager/assets/screenshot-2.png?rev=2828163)Fatal errors with the stack trace

![More log entries sample](https://ps.w.org/debug-log-manager/assets/screenshot-3.png?rev=2828163)More log entries sample

![Admin bar indicator and dashboard widget](https://ps.w.org/debug-log-manager/assets/screenshot-4.png?rev=2828163)Admin bar indicator and dashboard widget
...
## Reviews
	...
	![](https://secure.gravatar.com/avatar/4f0ef294038989ca9f0131e0a0627b0c289f0c498e3bdeb97f21f6fe940065a8?s=60&d=retro&r=g)### Time saving for debug. Highly recommended!
							[Julian Song](https://profiles.wordpress.org/julians3/)
								May 14, 2026
																1 reply
						Huge thanks Bowo for creating this plugin! Debug Log Manager makes troubleshooting WordPress issues so much easier. Being able to access and clear logs right from the admin area is a lifesaver. Highly recommended!
							![](https://secure.gravatar.com/avatar/a5598ead2e170886cf535f3e5a45380707bd4128fa0588f635857eb0994bdb01?s=60&d=retro&r=g)### best one I have used
							[roadlink](https://profiles.wordpress.org/roadlink/)
								March 3, 2026
						...
						It is so easy to debug with this plugin. Turn on and off whenever you want, find specific errors and have a clear overview. Also I like the feature not to have the usual debug location so it makes it harder for bots to find it.Also I had a request and it was solved within only one day! AWESOME WORK! Thank you so much!
							![](https://secure.gravatar.com/avatar/d9608dcc7402ba26bf4df2bdea9cca8e683e554e143815036581650e1062b224?s=60&d=retro&r=g)### Very useful
							[tldw](https://profiles.wordpress.org/tldw/)
								June 28, 2025
						This has saved much time debugging. Great plugin.

		[Read all 25 reviews](https://wordpress.org/support/plugin/debug-log-manager/reviews/)

## Contributors & Developers

	“Debug Log Manager – Conveniently Monitor and Inspect Errors” is open source software. The following people have contributed to this plugin.

Contributors
		- ![](https://secure.gravatar.com/avatar/98195d228e9177e36ca8a13d4c674356c6df724a3e0468dc646c9cc872a077a8?s=32&d=mm&r=g)				[Bowo](https://profiles.wordpress.org/qriouslad/)“Debug Log Manager – Conveniently Monitor and Inspect Errors” has been translated into 9 locales. Thank you to [the translators](https://translate.wordpress.org/projects/wp-plugins/debug-log-manager/contributors) for their contributions.

[Translate “Debug Log Manager – Conveniently Monitor and Inspect Errors” into your language.](https://translate.wordpress.org/projects/wp-plugins/debug-log-manager)

### Interested in development?

[Browse the code](https://plugins.trac.wordpress.org/browser/debug-log-manager/), check out the [SVN repository](https://plugins.svn.wordpress.org/debug-log-manager/), or subscribe to the [development log](https://plugins.trac.wordpress.org/log/debug-log-manager/) by [RSS](https://plugins.trac.wordpress.org/log/debug-log-manager/?limit=100&mode=stop_on_copy&format=rss).
...
- Security: Hardened unauthenticated 
```
log_js_errors
```

 AJAX endpoint against log injection (CVE-2026-9016). Added same-site Origin/Referer validation, rate limiting, stricter field sanitization, fixed 
```
[DLM JS]
```

 log prefix, capability check for wp-admin requests, and parser fix so browser-submitted entries cannot be misclassified as PHP errors. Props to Endang Alfarisi for responsibly disclosing this via Wordfence.
...
, if you’re trying to output a PHP 
```
$variable
```

 containing an array or object into the debug log. e.g. 
```
error_log( json_encode( $variable_name ) )
```

. Props to [@guyinpv](https://profiles.wordpress.org/guyinpv/) for [reporting the issue](https://wordpress.org/support/topic/doesnt-show-full-message/).
