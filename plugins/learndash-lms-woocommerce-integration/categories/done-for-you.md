...
**Source:** [https://learndash.com/support/kb/learndash-app/done-for-you/how-to-add-learndash-as-a-user-to-your-google-developer-account/](https://learndash.com/support/kb/learndash-app/done-for-you/how-to-add-learndash-as-a-user-to-your-google-developer-account/)
...
1. **Go to Google Play Console > Users and permissions.**Log in your [Google Play Console](https://play.google.com/console/) and open the **Users and permissions** section in the sidebar.
2. **Click Invite new users.**

![](https://learndash.com/support/wp-content/uploads/2025/09/2-800x450.png)

1. In the Email**address**, paste the address from your LearnDash questionnaire. Ensure **Set access expiry date** is **unchecked**.

![](https://learndash.com/support/wp-content/uploads/2025/09/3-800x450.png)

1. Under **App permissions**, add each app you want LearnDash to manage.
Click **Apply**.

![](https://learndash.com/support/wp-content/uploads/2025/09/4-800x450.png)

1. In the permissions modal, select **Admin (all permissions)**. Click **Apply**.

![](https://learndash.com/support/wp-content/uploads/2025/09/5-800x450.png)

1. Click **Invite user**. LearnDash will accept the invitation and gain access.

![](https://learndash.com/support/wp-content/uploads/2025/09/6-800x450.png)
