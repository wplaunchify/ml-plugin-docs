...
This will display the **“Above Header Background Image”** saved in the archive settings so it can be used when [designing](https://www.liquidweb.com/docs/kadence-theme/how-to-create-a-custom-archive-page-template-with-kadence-hooked-elements/) category, taxonomy, and other archive templates with **Kadence Blocks**. 
...
- The taxonomy term already has an image set in **Archive Custom Settings**.- These settings are found by editing the term, for example: **Dashboard > Posts > Categories > Edit**.

✅ **Tip:** Kadence has a guide for adding custom filters/functions safely.  You can read more about it [here.](https://www.liquidweb.com/docs/kadence-theme/how-to-add-a-custom-filter-or-function-with-code-snippets/)
...
- A [PHP snippet plugin](https://www.liquidweb.com/docs/kadence-theme/how-to-add-a-custom-filter-or-function-with-code-snippets/) (recommended for most sites)
...
1. Open the template or content where the taxonomy image should appear.- This works best on **taxonomy archive pages** (Category archives, Tag archives, and other term archives), or inside an archive template design.
...
![Dynamic Content Settings](https://res.cloudinary.com/lwcom/images/w_409,h_460,c_scale/f_auto,q_auto/v1780351029/prod/dynamic-content-settings/dynamic-content-settings.png?_i=AA)**Expected result:** If the term has an image set in Theme Kit Pro Archive Custom Settings, the image should render in the **Image (Adv)** block and for other dynamic options.
