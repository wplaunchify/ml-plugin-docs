...
If you have content in custom post types with Advance Custom Fields, either the free or pro version of their plugin, that data can be accessed and displayed using Kadence Elements Templating and dynamic content. To do so, you will need to have the [Kadence Theme Kit Pro](https://www.liquidweb.com/software/kadence/) plugin installed as well as Kadence Blocks Pro plugin installed. We recommend starting with the Kadence Express Plus if you’re using Kadence Elements Templating with Advanced Custom Fields.

For this overview, we will assume that you have some familiarity with Advanced Custom Fields and we’ll focus on how to display your content using Kadence Elements Templating and Dynamic Content. For an overview of how and when to set up custom post types, refer to our blog tutorial on [how and when you might want to use dynamic content and custom post types](https://www.liquidweb.com/blog/how-to-use-dynamic-content-with-kadence/).
...
![Kadence Elements Chose Type of Element](https://res.cloudinary.com/lwcom/images/w_1024,h_504,c_scale/f_auto,q_auto/v1780355833/prod/Element-Setup/Element-Setup.jpeg?_i=AA)Choose the type of Kadence Element you are creating
### Establish Template Settings

In the upper right corner, toggle into your Kadence Element Settings.

![element settings](https://res.cloudinary.com/lwcom/images/w_600,h_233,c_scale/f_auto,q_auto/v1780355828/prod/element-settings_4602421c6b9/element-settings_4602421c6b9.png?_i=AA)Toggle Element Settings on.**Set your Preview Settings.** Here, you will choose which of your content entries you will use to model what your template will look like.
...
![kadence elements preview settings](https://res.cloudinary.com/lwcom/images/w_1024,h_723,c_scale/f_auto,q_auto/v1780355817/prod/kadence-elements-preview-setup-dialog/kadence-elements-preview-setup-dialog.png?_i=AA)Set up your preview post settings so that you can work with specific data as you create your template.**Set your Placement Settings.**Placement tells Kadence Elements where you will be placing the template you’re designing. In the case of a template, we are replacing content on a page somewhere on your site.

![kadence elements placement settings](https://res.cloudinary.com/lwcom/images/w_600,h_691,c_scale/f_auto,q_auto/v1780355811/prod/kadence-elements-placement-settings/kadence-elements-placement-settings.png?_i=AA)Kadence Elements Templates Placement Settings**Set your Display Settings.** Display settings lets you determine where your element will be displayed. These can be set to display on specific portions of your site, or to exclude from specific portions of your site, and you can get as granular as you’d like with your settings.

![kadence elements display settings](https://res.cloudinary.com/lwcom/images/w_600,h_878,c_scale/f_auto,q_auto/v1780355804/prod/kadence-elements-display-settings/kadence-elements-display-settings.png?_i=AA)For display settings, choose where your template will display. On this example, we’re displaying this template on our single starter template custom post type.**Set your User Settings.**This is optional. User settings can be set by any user role that is set on your site. For example, you can choose to show to logged in users, logged out users, or any user role that you have. You can add rules so that you can show your template to administrators and shop managers, for example, by adding rules. Of course, keep in mind that if you’re limiting a Kadence Elements Template to show to a specific user role, then that user will need to be logged into your site in order to see it.
...
![](https://res.cloudinary.com/lwcom/images/w_800,h_340,c_scale/f_auto,q_auto/v1780355780/prod/dynamic-content-accessible-here/dynamic-content-accessible-here.png?_i=AA)
...
![](https://res.cloudinary.com/lwcom/images/w_854,h_1024,c_scale/f_auto,q_auto/v1780355787/prod/row-layout-background-image/row-layout-background-image.png?_i=AA)
...
![](https://res.cloudinary.com/lwcom/images/w_650,h_714,c_scale/f_auto,q_auto/v1780355774/prod/post-custom-field-advanced-text/post-custom-field-advanced-text.png?_i=AA)Find your post custom field to populate your Advanced Text Block content.You can add fixed text interspersed with dynamic text within the Advanced Text Block.
...
![](https://res.cloudinary.com/lwcom/images/w_800,h_462,c_scale/f_auto,q_auto/v1780355767/prod/dynamic-content-advanced-image-block/dynamic-content-advanced-image-block.png?_i=AA)Add dynamic images to the Advanced Image Block.Next, click the toggle to Enable Dynamic Image.

![](https://res.cloudinary.com/lwcom/images/w_600,h_536,c_scale/f_auto,q_auto/v1780355761/prod/advanced-image-find-dynamic-content/advanced-image-find-dynamic-content.png?_i=AA)Choose your dynamic image, which can either be the featured image or a Post Custom Field.You can also choose to animate the image on scroll, or even show the image conditionally. For example, if you do not want to show an image if there is none entered, you can choose to conditionally show the block if the image exists. In the example below, we are only showing the advanced image if the featured image URL is not empty (e.g., if there is a featured image, then show this advanced image block).
...
![](https://res.cloudinary.com/lwcom/images/w_600,h_274,c_scale/f_auto,q_auto/v1780355754/prod/advanced-button-dynamic-content/advanced-button-dynamic-content.png?_i=AA)Dynamic text on the button is shown with a blue underline.
#### Dynamic HTML Block
...
![](https://res.cloudinary.com/lwcom/images/w_800,h_444,c_scale/f_auto,q_auto/v1780355746/prod/dynamic-html-block/dynamic-html-block.png?_i=AA)Choose the content source via the block settings in the sidebar.
#### Dynamic List Block
...
![](https://res.cloudinary.com/lwcom/images/w_800,h_370,c_scale/f_auto,q_auto/v1780355741/prod/dynamic-list-block/dynamic-list-block.png?_i=AA)Choose the Dynamic List content in the sidebar.Was this article helpful?Yes NoThank you for your input.Thank you for your feedback.
