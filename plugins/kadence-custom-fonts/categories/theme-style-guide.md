...
**Source:** [https://www.kadencewp.com/help-center/docs/kadence-theme/theme-style-guide/](https://www.kadencewp.com/help-center/docs/kadence-theme/theme-style-guide/)
...
![Style Guide Demo](https://www.liquidweb.com/wp-content/uploads/2025/11/Style-Guide-Demo-scaled.jpg)
## Getting Started
...
You can access the Style Guide from the **Dashboard -> Appearance ->** **Customizer** by clicking the **Style Guide Icon** at the top left corner.![Style Guide Icon](https://res.cloudinary.com/lwcom/images/w_614,h_512,c_scale/f_auto,q_auto/v1780351273/prod/Style-Guide-Icon/Style-Guide-Icon.jpg?_i=AA)From here, you’ll see a live preview of various theme styles. You can hover over any Style Guide item to quickly edit that specific setting. When hovering, a **pencil icon** will appear. Click it to open the corresponding setting directly in the Customizer.

![Editing the Style Guide](https://res.cloudinary.com/lwcom/images/w_1024,h_696,c_scale/f_auto,q_auto/v1780351177/prod/Editing-the-Style-Guide_460741e4c28/Editing-the-Style-Guide_460741e4c28.gif?_i=AA)This makes it easy to visually adjust styles such as colors, typography, and buttons while immediately seeing how your changes affect the overall design of your site.
...
![Closing the Style Guide](https://res.cloudinary.com/lwcom/images/w_1024,h_749,c_scale/f_auto,q_auto/v1780351113/prod/Closing-the-Style-Guide_4607507d655/Closing-the-Style-Guide_4607507d655.jpg?_i=AA)The **Style Guide** consists of five main sections, each representing a key part of your site’s global design system. When changing settings related to these sections, you will see a live representation in the Customizer preview Style Guide.
...
![Site Identity Design Settings](https://res.cloudinary.com/lwcom/images/w_600,h_1002,c_scale/f_auto,q_auto/v1780351149/prod/Site-Identity-Design-Settings/Site-Identity-Design-Settings.jpg?_i=AA)![Site title and logo](https://res.cloudinary.com/lwcom/images/w_999,h_1024,c_scale/f_auto,q_auto/v1780351161/prod/Site-title-and-logo_460742d694c/Site-title-and-logo_460742d694c.jpg?_i=AA)[Learn more about the Kadence Header Items and their settings.](https://www.liquidweb.com/docs/kadence-theme/kadence-classic-header-items/)
...
![Site Icon Settings](https://res.cloudinary.com/lwcom/images/w_1024,h_410,c_scale/f_auto,q_auto/v1780351116/prod/Site-Icon-Settings/Site-Icon-Settings.jpg?_i=AA)**Recommended Size:**Use an image 512 × 512 pixels or larger. WordPress will automatically generate the smaller sizes (16×16, 32×32, 48×48, etc.) required by Google, browsers, and devices. Use a simple, recognizable design, and consider a transparent background for best results.
...
![Kadence Color Palette](https://res.cloudinary.com/lwcom/images/w_614,h_852,c_scale/f_auto,q_auto/v1780351281/prod/Kadence-Color-Palette_460688c03cd/Kadence-Color-Palette_460688c03cd.jpg?_i=AA)![Style Guide](https://res.cloudinary.com/lwcom/images/w_1024,h_941,c_scale/f_auto,q_auto/v1780351270/prod/Style-Guide_460693cfde4/Style-Guide_460693cfde4.jpg?_i=AA)The Kadence Color Palette is organized into four main groups, each serving a specific purpose:
...
[Learn more about the Kadence Theme Color Palette settings.](https://www.liquidweb.com/docs/kadence-theme/how-to-use-the-kadence-theme-color-palette/)
...
![Typography Style Guide](https://res.cloudinary.com/lwcom/images/w_1024,h_745,c_scale/f_auto,q_auto/v1780351135/prod/Typography-Style-Guide/Typography-Style-Guide.jpg?_i=AA)Each heading type (**H1**, **H2**, **H3**, etc.) represents a global setting for that level of heading across your site. The **Base Font** controls standard text elements such as paragraphs, menu items, and other general body text. From here, you can customize font families, weights, sizes, and line heights for each text type accordingly.

![Typography Settings Demo](https://res.cloudinary.com/lwcom/images/w_1024,h_626,c_scale/f_auto,q_auto/v1780351124/prod/Typography-Settings-Demo/Typography-Settings-Demo.gif?_i=AA)[Learn more about the Kadence Theme Typography settings.](https://www.liquidweb.com/docs/kadence-theme/typography-and-setting-font-sizes-for-different-devices/)
...
![Style Guide Buttons](https://res.cloudinary.com/lwcom/images/w_1024,h_737,c_scale/f_auto,q_auto/v1780351195/prod/Style-Guide-Buttons_4607159d31b/Style-Guide-Buttons_4607159d31b.jpg?_i=AA)Kadence provides three button style types: **Base**, **Secondary**, and **Outline**, which are used throughout your theme and can also be inherited by Kadence Blocks and Core Button Blocks.
...
![Base Button Styles](https://res.cloudinary.com/lwcom/images/w_386,h_1024,c_scale/f_auto,q_auto/v1780351180/prod/Base-Button-Styles/Base-Button-Styles.jpg?_i=AA)![Secondary Button](https://res.cloudinary.com/lwcom/images/w_401,h_1024,c_scale/f_auto,q_auto/v1780350922/prod/Secondary-Button_46071937401/Secondary-Button_46071937401.jpg?_i=AA)![Outline Button](https://www.liquidweb.com/wp-content/uploads/2025/11/Outline-Button.jpg)Changes made here apply globally to theme buttons and are inherited by Kadence and Core button blocks for consistent design across your site.

[Learn more about the Kadence Theme Button settings.](https://www.liquidweb.com/docs/kadence-theme/how-to-style-buttons/)
