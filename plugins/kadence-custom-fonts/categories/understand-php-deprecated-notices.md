# Understand Php Deprecated Notices
...
**Source:** [https://www.kadencewp.com/help-center/docs/kadence-theme/understand-php-deprecated-notices/](https://www.kadencewp.com/help-center/docs/kadence-theme/understand-php-deprecated-notices/)
...
- **Turn off debugging on live sites**. For any live or production site, debugging should be disabled. This keeps *PHP notices* (including deprecated warnings) from showing up to visitors. [Click here](https://www.liquidweb.com/docs/kadence-theme/how-to-enable-the-wordpress-error-logs/#disabling-debugging-after-use) to learn how.
