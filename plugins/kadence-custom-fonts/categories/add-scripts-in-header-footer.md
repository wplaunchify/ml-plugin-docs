...
**Source:** [https://www.kadencewp.com/help-center/docs/kadence-theme/add-scripts-in-header-footer/](https://www.kadencewp.com/help-center/docs/kadence-theme/add-scripts-in-header-footer/)

One of the features of Kadence Pro is providing fields in the Customizer where you can easily paste scripts that should go in your site’s header, right after opening the body tag and in the footer.
