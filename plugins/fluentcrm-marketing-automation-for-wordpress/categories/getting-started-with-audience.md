...
**Source:** [https://fluentcrm.com/docs/transfer-license-from-one-domain-to-another/](https://fluentcrm.com/docs/transfer-license-from-one-domain-to-another/)

You may already know [How to Install, Upgrade and Activate FluentCRM Licenses](https://fluentcrm.com/docs/how-to-install-upgrade-and-activate-license/) but sometimes it could be necessary to transfer your existing FluentCRM license from one domain to another. And this article will show you how to easily do so.

First, you need to deactivate your existing license.  This can be done in the following ways.

## Deactivate FluentCRM License from WordPress
...
![](https://fluentcrm.com/wp-content/uploads/2021/06/Screenshot_2-1.png)
...
![screenshot at aug 26 14 54 16 png 1196×445 1](https://fluentcrm.com/wp-content/uploads/2022/08/Screenshot-at-Aug-26-14-54-16-png-1196×445-1.png)

### Listing all Active Domains

You’ll see all your activated licenses. Click on the **Deactivate Site**to deactivate a license.

![screenshot at aug 26 14 59 33 png 1176×698 1](https://fluentcrm.com/wp-content/uploads/2022/08/Screenshot-at-Aug-26-14-59-33-png-1176×698-1.png)

## Activate License on New Domain

To use FluentCRM on another website, copy your license key from the WPManageNinja account dashboard. Then simply [Install and Activate FluentCRM](https://fluentcrm.com/docs/how-to-install-upgrade-and-activate-license/#Install-and-Activate-FluentCRM) free version and Pro add-on. The Pro add-on can also be found on your WPManageNinja account dashboard.

Next, go to FluentCRM **Settings** → **License Management**. And then you can paste the license key copied from your dashboard as guided in [Activate FluentCRM License](https://fluentcrm.com/docs/how-to-install-upgrade-and-activate-license/#Activate-FluentCRM-License)

---

## Introduction to FluentCRM Dashboard

**Source:** [https://fluentcrm.com/docs/dashboard-introduction/](https://fluentcrm.com/docs/dashboard-introduction/)

FluentCRM provides an excellent dashboard that represents all the necessary summaries of the activities. Total contacts, Email Campaigns sent from FluentCRM, All the emails generated and sent from FluentCRM, Tags, Email Templates, and many more on the front page or the dashboard.

![dashboard fluentcrm](https://fluentcrm.com/wp-content/uploads/2023/08/Dashboard-FluentCRM.png)

1. **Total Contacts:** The number of all contacts regardless of the contact status. All the contact statuses are included here.
2. **Campaigns:** The total number of Email Campaigns available in the dashboard.
3. **Emails Sent:** All the emails sent from FluentCRM. It can be from Email Campaigns, Email Sequences, Automations, or Test Emails.
4. **Tags:**The total number of Tags.
5. **Email Templates:** Number of Email Templates in the FluentCRM.
6. **Subscribers Growth:** This graph represents the subscribers’ growth in the FluentCRM by date. This can be filtered by date range.
7. **Quick Links:** This section is for commonly used helpful quick links that you can access fast.

That’s a quick overview of the FluentCRM dashboard that lets you see the overall performance and activities of the FluentCRM.
...
**Source:** [https://fluentcrm.com/docs/how-to-install-upgrade-and-activate-license/](https://fluentcrm.com/docs/how-to-install-upgrade-and-activate-license/)

**FluentCRM**is one of the easiest and fastest **Email Marketing**& **CRM solutions**for WordPress. This plugin can be installed from your WordPress dashboard. You can also download it from the [WordPress](https://wordpress.org/plugins/fluent-crm/) site and install it on your dashboard.
...
![fluent crm install](https://fluentcrm.com/wp-content/uploads/2023/08/Fluent-CRM-Install.png)
...
![fluentcrm upolad pro](https://fluentcrm.com/wp-content/uploads/2023/08/FluentCRM-Upolad-Pro.png)

## Update FluentCRM

It’s pretty easy to update both the Free and Pro versions. You can navigate to the plugin page of your dashboard, in order to check if an update is available. If any update is available just click on the update button.

Make sure that the pro version is activated with a valid license key. If you don’t have a license key or the license key is expired, you can purchase a new one or renew the existing one from **here**
...
![fluentcrm license](https://fluentcrm.com/wp-content/uploads/2023/08/FluentCRM-License.png)
...
You can start by going to the purchase history from the WPManageNinja [Account](https://wpmanageninja.com/account/dashboard/). Then you’ll see the ‘Renewing a license key?’ link on the checkout cart. Click on that.

![fluentcrm license renew 1](https://fluentcrm.com/wp-content/uploads/2023/08/FluentCRM-License-Renew-1.png)

After entering the license key, click the **Apply License Renewal**button then your license will be activated automatically.

![fluentcrm license renew 2](https://fluentcrm.com/wp-content/uploads/2023/08/FluentCRM-License-Renew-2.png)
...
**Source:** [https://fluentcrm.com/docs/migrating-into-fluentcrm/](https://fluentcrm.com/docs/migrating-into-fluentcrm/)
...
![migrating to fluentcrm from mailchimp](https://fluentcrm.com/wp-content/uploads/2020/10/migrating-to-fluentcrm-from-mailchimp.png)
...
![create list fluentcrm](https://fluentcrm.com/wp-content/uploads/2020/10/create-list-fluentcrm.png)
...
![create a tag fluentcrm](https://fluentcrm.com/wp-content/uploads/2020/10/create-a-tag-fluentcrm.png)

Go to the FluentCRM dashboard and choose the Contacts tab from the top and then click on Import from the top-right.

![](https://fluentcrm.com/wp-content/uploads/2020/09/import-aud-1536x490.png)

A popup will appear where you need to select the CSV as the contact source and then click next.

![](https://fluentcrm.com/wp-content/uploads/2020/09/import-aud2-1-1536x419.png)
...
![](https://fluentcrm.com/wp-content/uploads/2020/09/import-aud3-1536x790.png)
...
![](https://fluentcrm.com/wp-content/uploads/2020/09/import-aud4-1536x964.png)
...
![export contact list](https://fluentcrm.com/wp-content/uploads/2020/10/222-scaled.webp)
...
![import contact list](https://fluentcrm.com/wp-content/uploads/2020/10/33.webp)
