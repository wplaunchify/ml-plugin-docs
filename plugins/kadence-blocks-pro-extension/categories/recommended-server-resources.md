...
You can either modify these manually or contact your hosting provider to ensure these requirements are met.| Server Setting | Value |
| --- | --- |
...
The settings you’ll need to check can be found under two separate sections:![Site Health - Info tab](https://www.liquidweb.com/wp-content/uploads/2025/01/site-health-info-tab.png)
### Server Section
...
- PHP post max size *(Max Post Size)*![WordPress Health Check - Server Settings](https://www.liquidweb.com/wp-content/uploads/2025/01/Screenshot-2025-09-02-at-10.11.23-AM.png)
### WordPress Constants Section

In this section, you’ll find settings such as:

- WP_MEMORY LIMIT
- WP_MAX_MEMORY_LIMIT![Site Health - Info tab - WordPress section](https://res.cloudinary.com/lwcom/images/w_1024,h_533,c_scale/f_auto,q_auto/v1780433116/prod/Screenshot-2026-06-02-at-3.38.53-PM/Screenshot-2026-06-02-at-3.38.53-PM.png?_i=AA)For more information regarding WordPress memory limits, please see: [Editing wp-config.php](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#increasing-memory-allocated-to-php) in the WordPress Advanced Administration Handbook.
