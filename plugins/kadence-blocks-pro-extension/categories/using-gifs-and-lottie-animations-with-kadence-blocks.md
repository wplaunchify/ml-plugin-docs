...
**Source:** [https://www.kadencewp.com/help-center/docs/kadence-blocks/using-gifs-and-lottie-animations-with-kadence-blocks/](https://www.kadencewp.com/help-center/docs/kadence-blocks/using-gifs-and-lottie-animations-with-kadence-blocks/)

Using **GIFs** can effectively demonstrate information visually. Kadence Blocks supports GIF images, enabling you to display animated content across your website for a more engaging user experience. Additionally, Kadence Blocks offers the [Lottie Animation Block](https://www.liquidweb.com/docs/kadence-blocks/lottie-animation-block/), which allows you to incorporate **Lottie** **Animations** into your website, providing lightweight, scalable, and interactive animations for enhanced visual appeal.
...
![Kadence Gif](https://www.liquidweb.com/wp-content/uploads/2024/10/kadence.gif)Example of a Lottie Animation.Find more information below related to how GIFs and Lottie Animations work.
...
![Kadence Demo GIF](https://www.liquidweb.com/wp-content/uploads/2024/10/Kadence-Demo-GIF.gif)If you select a GIF image to use in a Kadence Block and the animation doesn’t play, make sure the Image File Size is set to **Full**. This is the only file size that allows GIFs to animate correctly.

![Image File Size Full](https://www.liquidweb.com/wp-content/uploads/2024/10/Image-File-Size-Full.gif)
## Using Lottie Animations with Kadence

[Lottie](https://lottiefiles.com/) is a separate platform from Kadence and WordPress that allows you to create and use high-quality animations across the web. It provides a wide range of pre-made animations (free and pro) that you can easily incorporate into your website. You can also create your own custom animations using the [Lottie Creator Tool](https://lottiefiles.com/lottie-creator) or other popular design tools like Adobe After Effects.

To obtain a **Lottie** **File** **Link** or **download** **one**, you must create an account on [LottieFiles.com](https://lottiefiles.com/). From there, you can download a Lottie file or obtain a file URL. Once you have the file or URL, you can integrate the animation into your site using the [Kadence Lottie Animation Block](https://www.liquidweb.com/docs/kadence-blocks/lottie-animation-block/).

### Downloading Lottie Files

You can download Lottie files directly from the Lottie website by logging into your account, selecting the desired animation, and clicking the **Download** button on the top right corner of the animation popup.![](https://www.liquidweb.com/wp-content/uploads/2024/10/Download-Lottie.gif)This will open the selected Lottie animation, allowing you to choose a downloadable option. Consider using an **optimized** **format** for **faster** loading times.![Download Lottie](https://www.liquidweb.com/wp-content/uploads/2024/10/Donwload-1024x780.jpg)To upload a downloaded Lottie file to the Lottie Animation Block, go to the **Block Settings** -> **General Tab** and change the **File Source** from **Remote URL** to **Local File**.

Next, add a name for the **Animation Title** and upload your downloaded Lottie file.

Once the animation is successfully uploaded, it will automatically be selected as the **Local File Source**, making it ready for use in your block.![Upload Downloaded Lottie](https://www.liquidweb.com/wp-content/uploads/2024/10/Upload-Downloaded-Lottie.jpg)
...
![Generate Asset Link](https://www.liquidweb.com/wp-content/uploads/2024/10/Generate-Asset-Link.jpg)![Asset Links](https://www.liquidweb.com/wp-content/uploads/2024/10/Asset-Links.jpg)Once you have the URL copied, navigate to the **Lottie Animation** block’s **General Settings**. Set the **File Source** to **Remote URL**.

Then, paste the URL from the generated asset link into the **Lottie Animation URL** block setting to apply the animation.![Source URL](https://www.liquidweb.com/wp-content/uploads/2024/10/Source-URL.jpg)For detailed settings and options related to the Lottie Block, please refer to the [Lottie Block documentation](https://www.liquidweb.com/docs/kadence-blocks/lottie-animation-block/).
