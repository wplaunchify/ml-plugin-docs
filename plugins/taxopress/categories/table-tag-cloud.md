...
if (typeof tagGroupsMakeTableResponsive === 'undefined') {
  ...
  if (typeof TagGroupsDynamicPostFilter !== 'undefined' && jQuery !== 'undefined' && jQuery.basictable !== 'undefined') {
          tagGroupsMakeTableResponsive('tag-groups-cloud-table-6a781c416789f','800');
    } else {
      jQuery(document).ready(function(){
        setTimeout(function(){tagGroupsMakeTableResponsive('tag-groups-cloud-table-6a781c416789f','800');}, 500);
      });
    }
```
...
if (typeof tagGroupsMakeTableResponsive === 'undefined') {
  ...
  if (typeof TagGroupsDynamicPostFilter !== 'undefined' && jQuery !== 'undefined' && jQuery.basictable !== 'undefined') {
          tagGroupsMakeTableResponsive('tag-groups-cloud-table-6a781c41681a2','800');
    } else {
      jQuery(document).ready(function(){
        setTimeout(function(){tagGroupsMakeTableResponsive('tag-groups-cloud-table-6a781c41681a2','800');}, 500);
      });
    }
```
