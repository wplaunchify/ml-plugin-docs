...
2. Click the **Create Bucket** button at the bottom.

Make a note of the **Region** you chose (like 
```
us-east-1
```
...
5. **Region:** Enter the region you chose when you created your bucket (e.g., 
```
us-east-1
```
