...
![Breakpoints](https://www.liquidweb.com/wp-content/uploads/2024/03/Breakpoints.gif)The Kadence Theme, Kadence Blocks plugin, and other Kadence products generally use the following responsive breakpoints:
...
Users sometimes want to know if they can customize these breakpoint values. However, there are no settings to change the breakpoints. If you need more control over styles at different screen widths, you must rely on media queries.![](https://www.liquidweb.com/wp-content/uploads/2024/03/Row-Layout-Layout-Settings-breakpoints.jpeg)
### WordPress Editor Preview vs. Kadence Responsive Breakpoints

When using the **Responsive Controls** in Kadence Blocks, you’ll notice the editor automatically adjusts its screen width as you switch between the desktop, tablet, and mobile icons. These screen widths are based on **WordPress Core’s built-in responsive preview sizes**.![Editor Preview in Mobile](https://www.liquidweb.com/wp-content/uploads/2024/03/Editor-Preview-in-Mobile.jpg)At the top right of the editor, you can also use the **Core preview controls** to switch between device views or open each view in a new tab. Both the Core preview options and Kadence’s responsive controls use the same underlying WordPress Core behavior for screen width changes, ensuring a consistent experience within the editor.![Responsive Editor Settings](https://www.liquidweb.com/wp-content/uploads/2024/03/Responsive-Editor-Settings.jpg)Kadence Blocks and the Kadence Theme apply specific responsive breakpoints to determine when styles switch between desktop, tablet, and mobile. These are:
