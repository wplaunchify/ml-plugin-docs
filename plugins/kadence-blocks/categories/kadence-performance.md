...
**Source:** [https://www.kadencewp.com/help-center/docs/kadence-blocks/kadence-performance/](https://www.kadencewp.com/help-center/docs/kadence-blocks/kadence-performance/)
...
Kadence Performance is a feature available in the [Free – Kadence Blocks Plugin](https://www.liquidweb.com/docs/kadence-blocks/installing-kadence-blocks/).

![Run Optimizer](https://res.cloudinary.com/lwcom/images/w_1024,h_581,c_scale/f_auto,q_auto/v1780352459/prod/Run-Optimizer/Run-Optimizer.gif?_i=AA)
...
The **Kadence** **Blocks** **Performance** **Optimizer** can be enabled globally using the [Kadence Block Controls](https://www.liquidweb.com/docs/kadence-blocks/the-kadence-block-controls/). In the Block Editor, navigate to Block Controls, then expand the **Performance** **Optimizer** **tab** to enable it.

![Optimizer-Settings](https://res.cloudinary.com/lwcom/images/w_778,h_1024,c_scale/f_auto,q_auto/v1780350911/prod/Optimizer-Settings_460730e3896/Optimizer-Settings_460730e3896.jpg?_i=AA)Additionally, you can disable the optimizer for an individual post or page by selecting **Exclude this post from optimization** in the Block Editor.
...
2. Navigate to the list view for the content you want to optimize
(for example: **Dashboard → Posts → All Posts**).
3. On the far right of each item, click **Run Optimizer**.

This will apply Kadence Performance optimizations to that specific post or page.

![Posts Example](https://www.liquidweb.com/wp-content/uploads/2025/08/Posts-Example-scaled.jpg)![Single Products](https://www.liquidweb.com/wp-content/uploads/2025/08/Single-Products-scaled.jpg)![CPT Example](https://res.cloudinary.com/lwcom/images/w_1024,h_485,c_scale/f_auto,q_auto/v1780352442/prod/CPT-Example-e1754519511248/CPT-Example-e1754519511248.jpg?_i=AA)Show MoreShow Less
...
![Remove Optimization](https://www.liquidweb.com/wp-content/uploads/2025/08/Remove-Optimization-scaled.jpg)Afterward, you will see a prompt in the dashboard, confirming you have removed optimization for that specific post.

![Reverted Message](https://www.liquidweb.com/wp-content/uploads/2025/08/Reverted-Message-scaled.jpg)
### Bulk Optimization
...
![Bulk Settings](https://res.cloudinary.com/lwcom/images/w_1024,h_379,c_scale/f_auto,q_auto/v1780350902/prod/bulk-settings_46073220220/bulk-settings_46073220220.png?_i=AA)
...
![Optimizer Status Filter](https://res.cloudinary.com/lwcom/images/w_1024,h_358,c_scale/f_auto,q_auto/v1780350894/prod/optimizer-status_460734b1cc3/optimizer-status_460734b1cc3.png?_i=AA)This makes it easy to quickly find which posts or pages are already optimized, need re-optimization, or have been excluded from Kadence Performance.
