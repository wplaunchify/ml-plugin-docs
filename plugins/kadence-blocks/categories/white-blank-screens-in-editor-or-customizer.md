# White Blank Screens In Editor Or Customizer
...
**Source:** [https://www.kadencewp.com/help-center/docs/kadence-blocks/white-blank-screens-in-editor-or-customizer/](https://www.kadencewp.com/help-center/docs/kadence-blocks/white-blank-screens-in-editor-or-customizer/)
...
Sometimes, an update can result in a blank screen, especially if outdated files are still cached. In these cases, be sure to fully clear all forms of caching, including your browser cache and any website/server-side cache you may be using. To learn more about clearing your cache, [click here](https://www.liquidweb.com/docs/kadence-theme/clearing-your-website-cache/).

Likewise, needing an update can also lead to issues. If you are using out-of-date plugins, themes, or PHP/WP versions, you can also run into blank screen-related issues. In these cases, you should update your website in a [staging environment](https://www.liquidweb.com/docs/kadence-theme/how-to-create-a-staging-website/) to see if the issue persists.
...
- **Create a Backup Before Major Changes** – You should always back up your website before making any major changes/updates to it. *(Learn more here.)*- **Always back up your site before:**- Updating WordPress, your theme, or plugins.
